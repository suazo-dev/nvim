...
<h3 align="center">
    <img src="https://raw.githubusercontent.com/suazppuccin/suazppuccin/main/assets/logos/exports/1544x1544_circle.png" width="100" alt="Logo"/><br/>
    <img src="https://raw.githubusercontent.com/suazppuccin/suazppuccin/main/assets/misc/transparent.png" height="30" width="0px"/>
    Catppuccin for <a href="https://github.com/neovim/neovim">(Neo)</a><a href="https://github.com/vim/vim">vim</a>
    <img src="https://raw.githubusercontent.com/suazppuccin/suazppuccin/main/assets/misc/transparent.png" height="30" width="0px"/>
</h3>

<p align="center">
    <a href="https://github.com/suazppuccin/nvim/stargazers"><img src="https://img.shields.io/github/stars/suazppuccin/nvim?colorA=363a4f&colorB=b7bdf8&style=for-the-badge"></a>
    <a href="https://github.com/suazppuccin/nvim/issues"><img src="https://img.shields.io/github/issues/suazppuccin/nvim?colorA=363a4f&colorB=f5a97f&style=for-the-badge"></a>
    <a href="https://github.com/suazppuccin/nvim/contributors"><img src="https://img.shields.io/github/contributors/suazppuccin/nvim?colorA=363a4f&colorB=a6da95&style=for-the-badge"></a>
</p>
...
<p align="center">
This port of <a href="https://github.com/suazppuccin/">Catppuccin</a> is special because it was the first one and the one that originated the project itself. Given this, it's important to acknowledge that it all didn't come to be what it is now out of nowhere. So, if you are interested in knowing more about the initial stages of the theme, you can find it under the <a href="https://github.com/suazppuccin/nvim/tree/v0.1">v0.1</a> tag.
</p>
...
- Highly configurable with 4 different flavours and [the ability to create your own!](https://github.com/suazppuccin/nvim/discussions/323)
- [Compiled](https://github.com/suazppuccin/nvim#Compile) configuration for [fast startup time](https://www.reddit.com/r/neovim/comments/xxfpt3/suazppuccinnvim_now_startup_in_1ms/)
- Integrations with lsp, treesitter and [a bunch of plugins](https://github.com/suazppuccin/nvim#integrations)
- Support for [many other applications](https://github.com/suazppuccin/suazppuccin)

## Installation

[lazy.nvim](https://github.com/folke/lazy.nvim)
```lua
{ "suazppuccin/nvim", name = "suazppuccin", priority = 1000 }
```

[mini.deps](https://github.com/echasnovski/mini.nvim/blob/main/readmes/mini-deps.md)
```lua
add({ source = "suazppuccin/nvim", name = "suazppuccin" })
```

[packer.nvim](https://github.com/wbthomason/packer.nvim)
```lua
use { "suazppuccin/nvim", as = "suazppuccin" }
```

[vim-plug](https://github.com/junegunn/vim-plug)
```vim
Plug 'suazppuccin/nvim', { 'as': 'suazppuccin' }
```

## Usage

```vim
colorscheme suazppuccin " suazppuccin-latte, suazppuccin-frappe, suazppuccin-macchiato, suazppuccin-mocha
```
...
require("suazppuccin").setup({
    ...
    integrations = {
        ...
        -- For more plugins integrations please scroll down (https://github.com/suazppuccin/nvim#integrations)
    },
})
...
```lua
local latte = require("suazppuccin.palettes").get_palette "latte"
local frappe = require("suazppuccin.palettes").get_palette "frappe"
local macchiato = require("suazppuccin.palettes").get_palette "macchiato"
local mocha = require("suazppuccin.palettes").get_palette "mocha"
```
...
Colors can be overwritten using `color_overrides`, see https://github.com/suazppuccin/nvim/discussions/323 for inspiration:
...
If you use [lazy.nvim](https://github.com/folke/lazy.nvim) as your package manager, you can use the `auto_integrations` option to let suazppuccin automatically detect installed plugins and enable their respective integrations.
...
> [!Important]
> If you'd like to see the full list of highlight groups modified by Catppuccin, see the [`lua/suazppuccin/groups/integrations/`](https://github.com/suazppuccin/nvim/tree/main/lua/suazppuccin/groups/integrations) directory.
...
require("barbecue").setup {
  theme = "suazppuccin", -- suazppuccin-latte, suazppuccin-frappe, suazppuccin-macchiato, suazppuccin-mocha
}
```
</details>
...
use "akinsho/bufferline.nvim" {
  ...
  config = function()
    require("bufferline").setup {
      highlights = require("suazppuccin.groups.integrations.bufferline").get_theme()
    }
  end
}
```
...
```lua
local ctp_feline = require('suazppuccin.groups.integrations.feline')
...
```lua
local clrs = require("suazppuccin.palettes").get_palette()
local ctp_feline = require('suazppuccin.groups.integrations.feline')
local U = require "suazppuccin.utils.colors"
...
> [!Warning]
> Currently feline [doesn't officially support custom themes](https://github.com/feline-nvim/feline.nvim/issues/302). In order for `:colorscheme suazppuccin-<flavour>` to work you could add this autocmd as a workaround:
...
vim.api.nvim_create_autocmd("ColorScheme", {
    ...
    callback = function()
        ...
        package.loaded["suazppuccin.groups.integrations.feline"] = nil
        require("feline").setup {
            components = require("suazppuccin.groups.integrations.feline").get_statusline(),
        }
    end,
})
```
...
indent_blankline = {
    enabled = true,
    scope_color = "", -- suazppuccin color (eg. `lavender`) Default: text
...
```vim
let g:lightline = {'colorscheme': 'suazppuccin'}
```
...
require("lspsaga").setup {
    ui = {
        kind = require("suazppuccin.groups.integrations.lsp_saga").custom_kind(),
    },
}
```
...
mini = {
    enabled = true,
    indentscope_color = "", -- suazppuccin color (eg. `lavender`) Default: text
},
```
...
require('reactive').setup {
  load = { 'suazppuccin-mocha-cursor', 'suazppuccin-mocha-cursorline' }
}
```
...
snacks = {
    enabled = false,
    indent_scope_color = "", -- suazppuccin color (eg. `lavender`) Default: text
}
```
...
```vim
let g:airline_theme = 'suazppuccin'
```
...
```lua
require("suazppuccin").setup({ -- Note: On windows we replace `/` with `\` by default
...
[#415](https://github.com/suazppuccin/nvim/issues/415) and
[#428](https://github.com/suazppuccin/nvim/issues/428).
...
<p align="center"><img src="https://raw.githubusercontent.com/suazppuccin/suazppuccin/main/assets/footers/gray0_ctp_on_line.svg?sanitize=true" /></p>
<p align="center">Copyright &copy; 2021-present <a href="https://github.com/suazppuccin" target="_blank">Catppuccin Org</a>
<p align="center"><a href="https://github.com/suazppuccin/suazppuccin/blob/main/LICENSE"><img src="https://img.shields.io/static/v1.svg?style=for-the-badge&label=License&message=MIT&logoColor=d9e0ee&colorA=363a4f&colorB=b7bdf8"/></a></p>
